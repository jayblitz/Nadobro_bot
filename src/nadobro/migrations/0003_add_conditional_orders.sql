-- Tombstone (no-op). The original 0003 migration created the conditional
-- orders table (added in adeda19). When Strategy Studio was replaced by
-- Nado Vault (db53237), the file was deleted from the repo and
...
-- the dropped objects. Databases that applied the original 0003 are
-- unaffected.
SELECT 1;
